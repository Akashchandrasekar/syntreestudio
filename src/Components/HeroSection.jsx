...
<div
    className="relative bg-cover bg-center h-screen flex items-center justify-end pr-8 md:pr-20 pb-15"
    style={{
...
>
    ...
    {/* Hero Content */}
    <div className="relative max-w-xl text-right z-10 p-4 md:p-8">
        <h1 className="text-white text-3xl md:text-5xl font-bold py-2 md:py-4">Welcome to Syntree <span className='text-pink-500'>Studio</span></h1>
