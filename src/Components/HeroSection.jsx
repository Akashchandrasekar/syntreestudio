...
const HeroSection = () => {
    ...
    return (
        ...
        <div
            className="relative bg-cover bg-center bg-no-repeat h-[70vh] md:h-screen flex items-center justify-end pr-4 md:pr-20 mt-0 pb-5"
            style={{
        ...
        >
            ...
            {/* Hero Content */}
            <div className="relative mt-10 mb-8 max-w-xl text-right z-10 p-4 md:p-8">
                ...
                <p className="text-white text-base md:text-2xl py-2 md:py-4">
